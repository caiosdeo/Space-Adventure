...
var drawScene3 = function() {
    ...
    text("GAME OVER", 85, height/2 - 20);
    text("You Died", 110, height/2 + 40);
    textSize(20);
    text("Try again", (width/2) - 40, (height/2) + 75);
    // exercicio
    ...
    println("Rank 1: " + ranking1);
    println("Rank 2: " + ranking2);
    println("tempoInicial: " + tempoInicial);
    println("tempoFinal: " + tempoFinal);
    println("tempoGameplay: " + tempoGameplay);
    text("Rank 1:", width / 2 - 40, height - 40);
    text("Rank 2:" + ranking2, width / 2 - 40, height + 40);
    text("Rank 3:" + ranking3, width / 2 - 40, height + 40);
};
...
Mover.prototype.display = function() {
  ...
  strokeWeight(2);
  fill(127);
  ellipse(this.position.x, this.position.y, 30+5, 30+5);
};
